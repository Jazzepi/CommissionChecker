...
*Implement a new site class extending the CommissionWebsite class
*Add the appropriate properties in the checker.properties
*Add an entry to the activeCommissionWebsites in the AppConfig class
*Add three new beans in the AppConfig, one for the username, the password, and the watched user list.